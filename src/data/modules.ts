...
export const assessmentItems: AssessmentItem[] = [
  ...
  },
  {
    id: 'q6',
    type: 'MCQ',
    question: 'Which of the following best describes the difference between stratified randomization and response-adaptive randomization?',
    options: [
      'Stratified randomization balances baseline prognostic factors; response-adaptive randomization changes allocation based on outcomes',
      'Stratified randomization is used in Phase I trials; response-adaptive randomization is used in Phase III trials',
      'They are the same concept with different names',
      'Stratified randomization requires Bayesian methods; response-adaptive randomization uses frequentist methods',
    ],
    correctAnswer: 'Stratified randomization balances baseline prognostic factors; response-adaptive randomization changes allocation based on outcomes',
    rationale: 'Stratified randomization ensures balance of known prognostic factors at baseline (before outcome data). Response-adaptive randomization modifies allocation probabilities based on accumulating outcome data during the trial.',
    difficulty: 'Medium',
    bloomLevel: 'Understand',
    tags: ['randomization', 'stratification', 'adaptive-design'],
  },
  {
    id: 'q7',
    type: 'True-False',
    question: 'In a Bayesian trial, if the 95% credible interval for treatment effect is [0.1, 0.5], we can say there is a 95% probability the true effect is between 0.1 and 0.5.',
    correctAnswer: 'True',
    rationale: 'This is the correct interpretation of a Bayesian credible interval. Unlike frequentist confidence intervals, credible intervals allow direct probability statements about parameter values given the observed data.',
    difficulty: 'Easy',
    bloomLevel: 'Understand',
    tags: ['bayesian', 'credible-interval'],
  },
  {
    id: 'q8',
    type: 'MCQ',
    question: 'An ML algorithm trained on historical trial data systematically assigns lower response probabilities to patients from underrepresented racial groups. What is the MOST important ethical concern?',
    options: [
      'The algorithm may be computationally inefficient',
      'Algorithmic bias could exclude populations from potentially beneficial treatments and perpetuate health disparities',
      'The algorithm needs more training data',
      'The algorithm violates patient privacy',
    ],
    correctAnswer: 'Algorithmic bias could exclude populations from potentially beneficial treatments and perpetuate health disparities',
    rationale: 'The primary ethical concern is fairness and justice. ML algorithms trained on biased historical data can systematically disadvantage underrepresented populations, leading to exclusion from trials and perpetuating healthcare inequities.',
    difficulty: 'Medium',
    bloomLevel: 'Evaluate',
    tags: ['ml', 'fairness', 'bias', 'ethics'],
  },
  {
    id: 'q9',
    type: 'MCQ',
    question: 'A trial uses O\'Brien-Fleming spending function for interim analyses. Which statement is TRUE?',
    options: [
      'The efficacy boundary is constant across all interim analyses',
      'More alpha is spent at early analyses compared to later analyses',
      'The efficacy boundary is very stringent early but approaches standard thresholds at final analysis',
      'Type I error cannot be controlled with this method',
    ],
    correctAnswer: 'The efficacy boundary is very stringent early but approaches standard thresholds at final analysis',
    rationale: 'O\'Brien-Fleming boundaries are conservative early (requiring strong evidence to stop) but become more liberal later, approaching standard significance levels (e.g., Z=1.96) at the final analysis.',
    difficulty: 'Medium',
    bloomLevel: 'Understand',
    tags: ['interim-analysis', 'alpha-spending', 'obrien-fleming'],
  },
  {
    id: 'q10',
    type: 'Scenario',
    question: 'A platform trial began when no effective COVID-19 treatments existed. Two years later, one experimental arm becomes FDA-approved and the new standard of care. The trial continues randomizing patients to the original placebo control. What is the PRIMARY ethical concern?',
    options: [
      'The trial is no longer statistically efficient',
      'Clinical equipoise is lost—patients in the control arm are being denied effective treatment',
      'The sample size calculation is incorrect',
      'The trial should use a non-inferiority design',
    ],
    correctAnswer: 'Clinical equipoise is lost—patients in the control arm are being denied effective treatment',
    rationale: 'When an effective treatment becomes available and becomes standard of care, genuine uncertainty (equipoise) no longer exists. Continuing to randomize patients to placebo violates the ethical principle that patients should receive the best proven treatment.',
    difficulty: 'Hard',
    bloomLevel: 'Evaluate',
    tags: ['ethics', 'equipoise', 'platform-trial'],
  },
  {
    id: 'q11',
    type: 'MCQ',
    question: 'What is the main advantage of using a Beta distribution as a prior for binary outcomes in Bayesian trials?',
    options: [
      'It is computationally faster than other distributions',
      'It is conjugate to the binomial likelihood, making posterior calculation straightforward',
      'It always produces narrower credible intervals',
      'It eliminates the need for sample size calculations',
    ],
    correctAnswer: 'It is conjugate to the binomial likelihood, making posterior calculation straightforward',
    rationale: 'The Beta distribution is conjugate to the binomial likelihood, meaning the posterior is also Beta distributed. This conjugacy makes Bayesian updating algebraically simple: if prior is Beta(α,β) and we observe x successes in n trials, posterior is Beta(α+x, β+n-x).',
    difficulty: 'Medium',
    bloomLevel: 'Understand',
    tags: ['bayesian', 'prior-distribution', 'conjugate-prior'],
  },
  {
    id: 'q12',
    type: 'MCQ',
    question: 'In a trial with 3 planned interim analyses, the conditional power at the second analysis is calculated to be 8%. What does this suggest?',
    options: [
      'The trial has an 8% chance of Type I error',
      'The trial should definitely continue to completion',
      'The trial is likely futile and stopping should be considered',
      'The treatment is 8% effective',
    ],
    correctAnswer: 'The trial is likely futile and stopping should be considered',
    rationale: 'Conditional power of 8% means there is only an 8% probability of ultimately rejecting the null hypothesis at trial completion, given current data. Such low conditional power (typically <20% threshold) indicates futility.',
    difficulty: 'Medium',
    bloomLevel: 'Apply',
    tags: ['conditional-power', 'futility', 'interim-analysis'],
  },
  {
    id: 'q13',
    type: 'True-False',
    question: 'Block randomization with blocks of size 4 guarantees perfect 1:1 balance after every 4 patients are enrolled.',
    correctAnswer: 'True',
    rationale: 'Block randomization with block size 4 ensures that every block of 4 consecutive patients has exactly 2 assigned to each treatment arm, guaranteeing balance at the end of each complete block.',
    difficulty: 'Easy',
    bloomLevel: 'Understand',
    tags: ['randomization', 'block-randomization'],
  },
  {
    id: 'q14',
    type: 'Scenario',
    question: 'A biotech company uses a proprietary "black box" ML model to determine adaptive dose escalation rules in a Phase I trial. The FDA requests transparency about the model\'s decision rules, but the company refuses, citing trade secrets. What is the MOST significant regulatory concern?',
    options: [
      'The company will lose patent protection',
      'The trial may be slower to complete',
      'Regulators cannot adequately assess patient safety and scientific validity without understanding the decision rules',
      'The model may be computationally expensive',
    ],
    correctAnswer: 'Regulators cannot adequately assess patient safety and scientific validity without understanding the decision rules',
    rationale: 'Regulatory agencies require sufficient transparency to evaluate patient safety and scientific validity of trial designs. Without understanding how the algorithm makes dosing decisions, they cannot fulfill their oversight responsibilities, particularly for safety.',
    difficulty: 'Hard',
    bloomLevel: 'Evaluate',
    tags: ['ethics', 'transparency', 'regulatory', 'ml'],
  },
  {
    id: 'q15',
    type: 'MCQ',
    question: 'Which of the following is NOT a valid reason to use an informative Bayesian prior in a clinical trial?',
    options: [
      'Incorporating results from previous trials in the same indication',
      'Using expert clinical opinion when limited data exists',
      'Ensuring the trial reaches the desired conclusion regardless of data',
      'Leveraging historical control data to reduce sample size in rare diseases',
    ],
    correctAnswer: 'Ensuring the trial reaches the desired conclusion regardless of data',
    rationale: 'Priors should represent genuine prior knowledge or beliefs, not be chosen to guarantee a particular conclusion. Using priors to manipulate results would be scientific misconduct and undermine trial integrity.',
    difficulty: 'Easy',
    bloomLevel: 'Understand',
    tags: ['bayesian', 'prior-distribution', 'ethics'],
  },
  {
    id: 'q16',
    type: 'MCQ',
    question: 'A trial protocol specifies "patients have a 50% chance of receiving treatment or placebo" but uses response-adaptive randomization. Later, allocation shifts to 70-30. Is re-consent required?',
    options: [
      'No, because the original consent was accurate at the time',
      'Yes, because the allocation probabilities have changed substantially',
      'Only if patients specifically request it',
      'Re-consent is never required in adaptive trials',
    ],
    correctAnswer: 'Yes, because the allocation probabilities have changed substantially',
    rationale: 'While there is debate, many ethicists and regulatory bodies argue that substantial changes in allocation probabilities may require updated consent to ensure patients have accurate information for autonomous decision-making. The consent should accurately describe procedures at the time of enrollment.',
    difficulty: 'Hard',
    bloomLevel: 'Evaluate',
    tags: ['informed-consent', 'adaptive-design', 'ethics'],
  },
  {
    id: 'q17',
    type: 'True-False',
    question: 'In adaptive trials, all design modifications must be pre-specified in the protocol to maintain statistical validity.',
    correctAnswer: 'True',
    rationale: 'To preserve Type I error control and scientific validity, all potential adaptations (sample size changes, allocation modifications, stopping rules) must be pre-specified in the protocol. Ad-hoc changes can inflate Type I error and bias results.',
    difficulty: 'Easy',
    bloomLevel: 'Remember',
    tags: ['adaptive-design', 'protocol', 'validity'],
  },
  {
    id: 'q18',
    type: 'MCQ',
    question: 'Predictive enrichment using an ML algorithm systematically excludes patients >75 years old. The sponsor argues this is scientifically justified for trial efficiency. What is the BEST counterargument?',
    options: [
      'Elderly patients should never be excluded from trials',
      'The algorithm might be inaccurate',
      'Excluding elderly patients limits generalizability and post-marketing knowledge about treatment effects in this population',
      'ML algorithms are not validated for clinical use',
    ],
    correctAnswer: 'Excluding elderly patients limits generalizability and post-marketing knowledge about treatment effects in this population',
    rationale: 'While enrichment may increase trial efficiency, systematic exclusion of elderly patients means we lack evidence about treatment effects in this population at approval. This creates post-market uncertainty and potential safety issues, as elderly patients often respond differently to treatments.',
    difficulty: 'Hard',
    bloomLevel: 'Evaluate',
    tags: ['predictive-enrichment', 'fairness', 'generalizability'],
  },
  {
    id: 'q19',
    type: 'MCQ',
    question: 'In a Bayesian analysis, what does it mean if P(treatment effect > 0 | data) = 0.97?',
    options: [
      'There is a 3% chance of Type I error',
      'The p-value is 0.03',
      'Given the data and prior, there is a 97% probability the treatment effect is positive',
      'The trial should be stopped for futility',
    ],
    correctAnswer: 'Given the data and prior, there is a 97% probability the treatment effect is positive',
    rationale: 'This is a posterior probability statement in Bayesian analysis. It directly quantifies the probability that the treatment effect is positive, conditional on the observed data and prior distribution.',
    difficulty: 'Medium',
    bloomLevel: 'Understand',
    tags: ['bayesian', 'posterior-probability'],
  },
  {
    id: 'q20',
    type: 'Scenario',
    question: 'A multi-arm trial uses a shared control arm. After the first experimental arm shows clear benefit and is approved, should the control arm be updated to this new standard of care for evaluating remaining experimental arms?',
    options: [
      'No, keep the original control for statistical consistency',
      'Yes, update to the new standard of care to maintain equipoise and ethical standards',
      'Only if the sponsor agrees',
      'Continue with placebo but inform patients they can access approved treatment post-trial',
    ],
    correctAnswer: 'Yes, update to the new standard of care to maintain equipoise and ethical standards',
    rationale: 'Once a treatment becomes the standard of care, clinical equipoise is lost for placebo-controlled comparisons. The control arm should be updated to the new standard to ensure patients receive appropriate care and maintain ethical validity of the trial.',
    difficulty: 'Hard',
    bloomLevel: 'Evaluate',
    tags: ['platform-trial', 'equipoise', 'ethics', 'standard-of-care'],
  },
]
